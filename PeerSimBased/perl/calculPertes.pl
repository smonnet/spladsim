...
#  cut -f 2 lastlines.txt |<path to>/calculPertes.pl
...
print "# nombre initial de fichiers  mean  standard_deviation min max cffvariation  mean-error mean+error\n"; 
